...
const r1 = r++ + r++;           //후위형 ++, 뒤의 연산을 하지않고  앞의 연산을 먼저 수행함. 2+3
console.log(`r1= ${r1}`);
console.log(`r = ${r}`);

const r2 = ++r + ++r;          //전위형 ++, 앞의 ++를 먼저 진행하고  덧셈 연산을 수행함. 5+6
console.log(`r2 = ${r2}`);
console.log(`r = ${r}`);
...
r= 10;
console.log(`r = ${r}`);
var r5 = r-- + r--;       //후위형 -- : 앞의 연산은 진행되지않고 뒤의 연산만 진행됨
console.log(`r5 = ${r5}`);
console.log(`r = ${r}`);
...
while (true) {
    n += 0.1;
    /*if (n == 0.3)*/     //비교대상인 0.3과 증가한 0.3은 동일한 수가 아님. 무한반복에 빠져 나쁜 코드가 됨.
...
var skipIt = true;
x =0;
var result = skipIt || x++;  //or연산의 오른쪽은 판단하지않음.
console.log(`\nskipIt = ${skipIt}`);
console.log(`x=${x}`);
...
console.log();
//피보나치 수열 변수3개 사용하여 구, 여기서는 j가 반복제어 변수
